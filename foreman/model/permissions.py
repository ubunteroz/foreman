...
permissions = {
    ...
    ('Task', 'add_file'): And(Or(AdminChecker(), CompleteInvestigationForTaskChecker(),
                                    CaseManagerForTaskChecker()), Not(ArchivedTaskChecker())),
    ...
    ('Evidence', 'view'): Or(
                        ...
                        And(
                            ...
                            PrivateTaskChecker())),
    ('Evidence', 'add_file'): And(Or(AdminChecker(), CompleteInvestigationForTaskChecker(),
                                    CaseManagerForEvidenceChecker()), Not(ArchivedEvidenceChecker())),
    ('Evidence', 'delete_file'): And(Or(AdminChecker(), CompleteInvestigationForTaskChecker(),
